...
import { createUser, getConstituency, getDistrict, getState } from '../utils/networkCalls';
        ...
        <div className='w-full h-full flex flex-col justify-start items-center'>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className='w-1/2 flex flex-col justify-center items-center border-2 border-blue-500 p-4 rounded-lg mt-4 gap-3'>
                <div className='w-full flex flex-col gap-2'>
                    ...
                    {errors.name && <span className="text-red-500">Name is required and must be less than 20 characters</span>}
                </div>
                <div className='w-full flex flex-col gap-2'>
                ...
                <div className='w-full flex flex-col gap-2'>
                    ...
                    {errors.password && <span className="text-red-500">Password is required and must be less than 20 characters</span>}
                </div>
                <div className='w-full flex flex-col gap-2'>
